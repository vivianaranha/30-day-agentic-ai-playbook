...
[32m[32m[1m13 passed[0m[32m in 1.10s[0m[0m
...
artifact_tool.rpc.client.RemoteError: hydrateCrdtFromProto requires an empty collaborative document.
Traceback (most recent call last):
  File [35m"/mnt/data/30-day-agentic-ai-playbook/examples/05_super_agent.py"[0m, line [35m1[0m, in [35m<module>[0m
    from agentic_ai.agents.super_agent import SuperAgent
[1;35mModuleNotFoundError[0m: [35mNo module named 'agentic_ai'[0m
```

## Repository statistics

- Days: 30
- Core Python modules: 25
- Automated test files: 6
- Knowledge documents: 3
- Files before this verification report: 163
